    ...
    <main class="flex-grow flex items-center justify-center py-12 px-6 bg-gray-50">
        <div class="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 min-h-[650px]">
            <div class="bg-willow-dark hidden md:flex flex-col justify-center items-center p-12 text-center text-white">
                ...
                <p class="text-xs text-gray-300 leading-relaxed max-w-xs">Submit your professional details and upload verified proof of your degree or medical certification.</p>
            </div>

            <div class="p-10 flex flex-col justify-center">
                <h2 class="text-xl font-serif font-bold text-willow-dark mb-1">Doctor Account</h2>
                <p class="text-xs text-gray-400 mb-6">Provide your information and certification to join the Willow Care medical community.</p>
                <p id="doctor-signup-error" class="text-xs text-red-500"></p>
                <form id="doctor-signup-form" class="space-y-4">
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Full Name</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Email Address</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Password</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-0.5">Proof of Degree / Certification</label>
                        <input type="file" name="certification" accept="image/*" class="w-full text-[10px] text-gray-600" />
                        <p class="text-[10px] text-gray-400 mt-2">Upload an image of your license, diploma, or other official certification.</p>
                    </div>
                    <div class="space-y-2">
