    ...
    <main class="flex-grow flex items-center justify-center py-12 px-6 bg-gray-50">
        <div class="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 min-h-[500px]">
            <div class="p-10 flex flex-col justify-center">
                ...
                <p class="text-xs text-gray-400 mb-8">Secure access for medical professionals. Log in with your doctor account.</p>
                <form id="doctor-login-form" class="space-y-4">
                    ...
                    <p id="doctor-login-error" class="text-xs text-red-500 hidden"></p>
                ...
                <p class="text-xs text-center text-gray-500 mt-8">New here? <a href="doctor_signup.php" class="text-willow-mid font-bold hover:underline">Create a doctor account</a></p>
            </div>
            <div class="bg-willow-accent/40 hidden md:flex flex-col justify-center items-center p-12 text-center relative">
                <div class="relative z-10">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed max-w-xs">Use this login page if you are a certified doctor and want to join Willow Care as a medical professional.</p>
                </div>
            </div>
        </div>
    </main>
