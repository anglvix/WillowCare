<?php
$page_title = 'Willow Care - Organization Profile';
$html_lang = 'pt';
$base_path = '../';
...
<body class="bg-white font-sans antialiased text-gray-900 min-h-screen flex flex-col">
    ...
    <main class="max-w-3xl mx-auto w-full px-6 py-12 flex-grow space-y-6">
        ...
        <section class="flex flex-col sm:flex-row items-center gap-4 bg-willow-dark text-white p-6 rounded-2xl shadow-sm">
            <div id="org-initials" class="w-16 h-16 bg-white text-willow-dark rounded-full flex items-center justify-center font-bold text-xl shrink-0">...</div>
            <div class="text-center sm:text-left">
                <h1 id="org-name" class="text-xl font-serif font-bold">A carregar...</h1>
        ...
        <section id="org-services" class="flex flex-wrap gap-3"></section>
    </main>
